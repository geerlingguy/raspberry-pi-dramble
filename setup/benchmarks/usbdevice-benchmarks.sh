...
# Usage:
#   # Run it locally.
#   $ sudo ./usbdevice-benchmarks.sh
#
#   # Run it straight from GitHub.
#   $ curl https://raw.githubusercontent.com/geerlingguy/raspberry-pi-dramble/master/setup/benchmarks/usbdevice-benchmarks.sh | sudo bash
#
...
printf "usbdevice benchmark complete!\n\n"
